...
a local `docker compose up` or an SSH tunnel to <infra-host>
...
the private-overlay IP (e.g. the private overlay `<overlay-ip>`), never a public NIC — the
